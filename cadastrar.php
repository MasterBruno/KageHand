  ...
  <!-- END header -->
    ...
    <section class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h2 class="mb-5">Formulário para Cadastro</h2>
                <form action="register.php" method="post">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6 form-group">
                      ...
                      <input type="text" id="cartao" class="form-control " name="cartao" maxlength="19" OnKeyPress="formatar('####-####-####-####', this)">
                    </div>
                  </div>
                    ...
                    <div class="form-row">
                      <div class="col-md-10">
                        <div class="form-label-group">
                          ...
                          <input type="text" id="inputRua" class="form-control" name="rua" placeholder="Rua" name="rua" required="required">
                        </div>
                      </div>
                      <div class="col-md-2">
                        <div class="form-label-group">
                          <label for="inputNumero">Número</label>
                          <input type="text" id="inputNumero" class="form-control" name="numero" placeholder="Número" name="numero" required="required">
                        </div>
                      </div>
                    </div>
                    <br>
                    <div class="form-row">
                      ...
                      <div class="col-md-8">
                        <div class="form-label-group">
                          ...
                          <input type="text" id="inputBairro" class="form-control" name="bairro" placeholder="Bairro" name="bairro" required="required">
                        </div>
                      </div>    
                    </div>
                  </div>
                    ...
                    <div class="form-row">
                      <div class="col-md-8">
                        <div class="form-label-group">
                          ...
                          <input type="text" id="inputCidade" class="form-control" name="cidade" placeholder="Cidade" name="cidade" required="required">
                        </div>
                      </div>
                      <div class="col-md-4">
                        <div class="form-label-group">
                  ...
                  <div class="row">
                    <div class="col-md-6 form-group">
                      <input type="submit" value="Cadastre Agora" class="btn btn-primary">
                    </div>
                  </div>
                </form>
              </div>
